...
def _any_instance_connected(db) -> bool:
    ...
    if WASENDER_PAT:
        try:
            from app.providers.legacy.wasender import pick_connected_instance as _ws_pick
    ...
    if WAHA_API_KEY:
        try:
            from app.providers.legacy.waha import pick_connected_instance as _waha_pick
...
def _send_via_waha(db, company_id: str, to_number: str, message: str, job_id: str, delay_ms: int = 0, session: str = "",
    ...
    from app.providers.legacy.waha import WAHAClient, get_all_connected_instances as _waha_all
    ...
    try:
        ...
        from app.providers.legacy.waha import _clean_digits as _wc
...
def _send_via_wasender(db, company_id: str, to_number: str, message: str, job_id: str, delay_ms: int = 0, session: str = "",
    ...
    from app.providers.legacy.wasender import WasenderClient, get_all_connected_instances as _wasender_all, _clean_digits as _wc
...
def _heartbeat_idle_waha_sessions():
    ...
    try:
        ...
        from app.providers.legacy.waha import WAHAClient
