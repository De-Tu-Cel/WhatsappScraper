          ...
          slotProps={{ input: {
            ...
            endAdornment: search ? (
              <InputAdornment position="end">
                <IconButton size="small" onClick={() => setSearch('')} sx={{ p: 0.3, color: 'var(--text-muted)', '&:hover': { color: 'var(--text)' } }}>
        ...
        slotProps={{
          input: {
            ...
            endAdornment: filters.search ? (
              <InputAdornment position="end">
                <IconButton size="small" onClick={() => onChange('search', '')} sx={{ p: 0.3, color: 'var(--text-muted)', '&:hover': { color: 'var(--text)' } }}>
